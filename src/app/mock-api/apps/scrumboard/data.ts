...
export const cards = [
    {
        ...
        position   : 65536,
        title      : 'Example that showcase all of the available bits on the card with my-collection fairly long title compared to other cards',
        description: 'Example that showcase all of the available bits on the card with my-collection fairly long title compared to other cards. Example that showcase all of the available bits on the card with my-collection fairly long title compared to other cards.',
        labels     : [
    ...
    },
    {
        ...
        listId  : 'a2df7786-519c-485a-a85f-c09a61cc5f37',
        position: 131072,
        title   : 'Do my-collection research about most needed admin applications',
        labels  : [
            'e0175175-2784-48f1-a519-a1d2e397c9b3'
        ],
        dueDate : null
    ...
    },
    {
        ...
        listId  : '34cbef38-5687-4813-bd66-141a6df6d832',
        position: 262144,
        title   : 'Do my-collection research about latest UI trends',
        labels  : [
            'e0175175-2784-48f1-a519-a1d2e397c9b3'
        ],
        dueDate : null
