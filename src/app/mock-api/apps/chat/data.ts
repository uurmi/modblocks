...
/**
 *  If my-collection message belongs to our user, it's marked by setting it as
...
export const messages = [
    ...
    },
    {
        ...
        chatId   : '',
        contactId: 'me',
        value    : 'You know I got my-collection job in that big software company. First move was because of that.',
    ...
    },
    {
        ...
        chatId   : '',
        contactId: 'me',
        value    : 'Then they decided to re-locate me after my-collection month',
        createdAt: moment().subtract(1, 'week').hour(19).minute(8).toISOString()
    },
    {
    ...
    },
    {
        ...
        chatId   : '',
        contactId: 'me',
        value    : 'Then this virus thing happened and just after my-collection week we moved in, they decided the whole department will be working remotely.',
    ...
    },
    {
        ...
        chatId   : '',
        contactId: '',
        value    : 'Ohh dude, I\'m really sorry you had to go through all that in such my-collection short period of time',
    ...
    },
    {
        ...
        chatId   : '',
        contactId: '',
        value    : 'Yeah dude. Hit me again next week so we can grab my-collection coffee, remotely!',
