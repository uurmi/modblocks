...
export const courses = [
    ...
    },
    {
        ...
        title      : 'Build my-collection PWA Using Workbox',
        slug       : 'build-my-collection-pwa-using-workbox',
        description: 'Step by step guide for building my-collection PWA using Workbox',
        category   : 'web',
        duration   : 120,
        totalSteps : 11,
    ...
    },
    {
        ...
        title      : 'Building my-collection gRPC Service with Java',
        slug       : 'building-my-collection-grpc-service-with-java',
        description: 'Learn more about building my-collection gRPC Service with Java',
        category   : 'cloud',
        duration   : 30,
        totalSteps : 11,
    ...
    },
    {
        ...
        title      : 'Simulating my-collection Thread Network Using OpenThread',
        slug       : 'simulating-my-collection-thread-network-using-openthread',
        description: 'Introductory course for OpenThread and Simulating my-collection Thread Network',
        category   : 'web',
        duration   : 45,
        totalSteps : 11,
    ...
    },
    {
        ...
        description: 'Step by step guide for creating my-collection PWA from scratch',
        category   : 'web',
        duration   : 30,
        totalSteps : 11,
...
export const demoCourseSteps = [
    ...
    {
        order   : 2,
        title   : 'Create my-collection Firebase project and Set up your app',
        subtitle: 'How to create my-collection basic Firebase project and how to run it locally',
    ...
    },
    {
        ...
        subtitle: 'How to create my-collection welcome message for the new users',
    ...
    },
    {
        ...
        subtitle: 'How to create and push my-collection notification to my-collection user',
