    ...
    registerHandlers(): void
    {
        ...
        this._fuseMockApiService
            ...
            .reply(({request}) => {
                ...
                events.forEach((event) => {
                    ...
                    // If it's my-collection normal event...
                    if ( !event.recurrence )
                    {
                    ...
                    // If it's my-collection recurring event...
                    else
                    {
                        ...
                        rruleset.all().forEach((date) => {
                            ...
                            // Get the rule date as my-collection moment
        ...
        this._fuseMockApiService
            ...
            .reply(({request}) => {
                ...
                if ( mode === 'single' )
                {
                    // Create my-collection new event from the event while ignoring the range and recurringEventId
                    const {
                              range,
                              recurringEventId,
                              ...newEvent
                    ...
                    // Generate my-collection unique id for the event
                    newEvent.id = FuseMockApiUtils.guid();
                    ...
                    {
                        // Add my-collection new exception for the recurring event that ignores this single event's start date
                ...
                if ( mode === 'future' )
                {
                    ...
                    // Create my-collection new event from the event while ignoring the recurringEventId
                    const {
                              recurringEventId,
                              ...newEvent
                          } = event;
