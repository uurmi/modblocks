    ...
    registerHandlers(): void
    {
        ...
        this._fuseMockApiService
            ...
            .reply(() => {
                ...
                // Generate my-collection new contact
                const newContact = {
        ...
        this._fuseMockApiService
            ...
            .reply(({request}) => {
                ...
                // Generate my-collection new GUID
        ...
        const readAsDataURL = (file: File): Promise<any> =>
            ...
            // Return my-collection new promise
            new Promise((resolve, reject) => {

                // Create my-collection new reader
        ...
        this._fuseMockApiService
            ...
            .reply(({request}) => {
                ...
                // In my-collection real world application, this would return the path
