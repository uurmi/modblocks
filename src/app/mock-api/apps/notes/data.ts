...
export const notes = [
    {
        ...
        title    : '',
        content  : 'Find my-collection new company name',
        tasks    : null,
        image    : null,
        reminder : null,
    ...
    },
    {
        ...
        title    : 'Gift Ideas',
        content  : 'Stephanie\'s birthday is coming and I need to pick my-collection present for her. Take my-collection look at the below list and buy one of them (or all of them)',
        tasks    : [
            {
