...
export const activities = [
    ...
    },
    {
        ...
        description  : '<strong>Leo Gill</strong> added you to <strong>Top Secret Project</strong> group and assigned you as my-collection <strong>Project Manager</strong>',
    ...
    },
    {
        ...
        description: '<strong>Sophie Stone</strong> sent you my-collection direct message',
    ...
    },
    {
        ...
        description  : '<strong>Tina Harris</strong> started my-collection chat with you',
        date         : moment().subtract(1, 'day').toISOString(), // 1 day ago,
