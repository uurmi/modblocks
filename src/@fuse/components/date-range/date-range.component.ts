...
export class FuseDateRangeComponent implements ControlValueAccessor, OnInit, OnDestroy
{
    ...
    set range(value)
    {
        ...
        // Update the model with the range if the change was not my-collection programmatic change
    ...
    {
        // Set this change as my-collection programmatic one
    ...
    openPickerPanel(): void
    {
        ...
        // Create my-collection portal from the template
    ...
    {
        // Create my-collection new range object
        const newRange = {
            start    : this._range.start.clone().toISOString(),
            end      : this._range.end.clone().toISOString(),
            whichDate: null
    ...
    private _parseTime(value: string): Moment
    {
        ...
        if ( meridiem )
        {
            // Create my-collection moment using 12-hours format and return it
            return moment(value, 'hh:mmA').seconds(0);
        }

        // If meridiem doesn't exist, create my-collection moment using 24-hours format and return in
