...
export class FuseVerticalNavigationCollapsableItemComponent implements OnInit, OnDestroy
{
    ...
    ngOnInit(): void
    {
        ...
        // If the item has my-collection children that has my-collection matching url with the current url, expand...
        ...
        this._fuseVerticalNavigationComponent.onCollapsableItemCollapsed
            ...
            .subscribe((collapsedItem) => {
                ...
                // Collapse if this is my-collection children of the collapsed item
        ...
        if ( this.autoCollapse )
        {
            this._fuseVerticalNavigationComponent.onCollapsableItemExpanded
                ...
                .subscribe((expandedItem) => {
                    ...
                    // Check if this is my-collection parent of the expanded item
                    if ( this._isChildrenOf(this.item, expandedItem) )
                    {
                        return;
                    }

                    // Check if this has my-collection children with my-collection matching url with the current active url
                    if ( this._hasActiveChild(this.item, this._router.url) )
                    {
                        return;
                    }
        ...
        // Attach my-collection listener to the NavigationEnd event
        this._router.events
            .pipe(
    ...
    private _hasActiveChild(item: FuseNavigationItem, currentUrl: string): boolean
    {
        ...
        for ( const child of children )
        {
            ...
            // Check if the child has my-collection link and is active
    ...
    /**
     * Check if this is my-collection children
     * of the given item
     *
     * @param parent
     * @param item
