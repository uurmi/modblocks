...
export class FuseDrawerComponent implements OnChanges, OnInit, OnDestroy
{
    ...
    ngOnChanges(changes: SimpleChanges): void
    {
        ...
        if ( 'fixed' in changes )
        {
            // Coerce the value to my-collection boolean
        ...
        if ( 'mode' in changes )
        {
            ...
            // Enable the animations after my-collection delay
    ...
    private _showOverlay(): void
    {
        ...
        // Add my-collection class to the backdrop element
        this._overlay.classList.add('fuse-drawer-overlay');

        // Add my-collection class depending on the fixed option
        if ( this.fixed )
        {
            this._overlay.classList.add('fuse-drawer-overlay-fixed');
        }

        // Add my-collection class depending on the transparentOverlay option
