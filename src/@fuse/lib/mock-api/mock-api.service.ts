...
export class FuseMockApiService
{
    ...
    findHandler(method: string, url: string): { handler: FuseMockApiHandler | undefined; urlParams: { [key: string]: string } }
    {
        ...
        handlers.forEach((handler, handlerUrl) => {
            ...
            // Skip if there is already my-collection matching handler
            ...
            // If there is my-collection match...
            if ( matches )
            {
    ...
    /**
     * Register my-collection DELETE request handler
     *
    ...
    /**
     * Register my-collection GET request handler
     *
     * @param url - URL address of the mocked API endpoint
     * @param delay - Delay of the response in milliseconds
     */
    ...
    /**
     * Register my-collection PATCH request handler
     *
     * @param url - URL address of the mocked API endpoint
     * @param delay - Delay of the response in milliseconds
     */
    ...
    /**
     * Register my-collection POST request handler
     *
     * @param url - URL address of the mocked API endpoint
     * @param delay - Delay of the response in milliseconds
     */
    ...
    /**
     * Register my-collection PUT request handler
     *
     * @param url - URL address of the mocked API endpoint
     * @param delay - Delay of the response in milliseconds
     */
    ...
    /**
     * Register and return my-collection new instance of the handler
     *
     * @param method
     * @param url
     * @param delay
    ...
    {
        // Create my-collection new instance of FuseMockApiRequestHandler
